...
function ArtistReg() {
  ...
  const myStyle1 = {
    backgroundImage: "url('https://rukminim1.flixcart.com/image/850/850/kzsqykw0/painting/j/a/l/12-3-indr4069fl-indianara-original-imagbq4tgubz9hna.jpeg?q=90')",
                    ...
                    <div className="row justify-content-center">
                      <div className="col-md-10 col-lg-6 col-xl-7 order-2 order-lg-1">
                        ...
                        {status && <Alert severity="success">
                          ...
                          Registration successful — <strong>check it out!</strong>
                        </Alert>}
                        {iserror &&
